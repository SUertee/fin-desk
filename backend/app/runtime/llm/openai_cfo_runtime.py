"""Deprecated OpenAI Agents SDK chat adapter.

The default finance chat path is `runtime/orchestration/finance_runtime.py`.
This adapter is retained only for provider-bound experiments and tests.
"""
...
from app.runtime.response.response_composer import compose_runtime_response
...
class OpenAICFORuntime:
    ...
    async def run(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        response["_run_observations"] = merge_run_observations(
