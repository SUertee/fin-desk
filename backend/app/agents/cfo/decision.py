...
class CfoDecisionEngine:
    ...
    def _system_prompt() -> str:
        return (
            ...
            "and answers that need no external evidence. Use ask_clarification when a "
            "safe answer requires missing information. Use execute only when registered "
            "financial evidence or a specialist is required. For execute, reply must be "
            "null and capability_requests must contain capability_id objects. Never "
